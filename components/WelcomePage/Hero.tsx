...
export default function Hero() {
  return (
    <div className="w-full h-screen bg-gray-900 flex flex-col mt-10  items-center">
        ...
        <button type="button" className="w-[80%] sm:w-fit text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">marketplace</button>
