...
<section className="bg-white dark:bg-gray-900 mt-10">
    <div className="flex justify-center min-h-screen">
        {/* in here goes back grounded imge */}
        <div className="hidden bg-cover lg:block lg:w-2/5 background"  >
            ...
            <div className="w-full">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-3 md:flex md:items-center md:-mx-2">
                        <button className="flex justify-center w-full px-6 py-3 text-white bg-red-500 rounded-md md:w-auto md:mx-2 focus:outline-none">
                        ...
                        <button className="flex justify-center w-full px-6 py-3 mt-4 text-red-500 border border-red-500 rounded-md md:mt-0 md:w-auto md:mx-2 dark:border-red-400 dark:text-red-400 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                    ...
                    <button
                        className="flex items-center justify-between w-full px-6 py-3 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-500 rounded-md hover:bg-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-50">
                        <span>Sign Up </span>
